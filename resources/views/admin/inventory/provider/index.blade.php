        ...
        <div class="col-lg-12">
            <div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5">
                <div class="row justify-content-between">
                    <div class="col-md-12">
                        <form action="{{route('admin.inventory.provider.search')}}" method="get">
                            <div class="row">
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light tabstyle--two">
                            ...
                            @forelse ($inventories as $item)
                                <tr>
                                    <td data-label="@lang('Service')">{{ __(@$apiProviders->where('id',$item->order_placed_to_api)->first()->name) }}</td>
